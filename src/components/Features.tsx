      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            Immerse yourself in a rich and ever-expanding universe where a vibrant array on products converge into an interconnected overlay experience on your world.
          </p>
        </div>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard 
              ...
              title={<>n<b>e</b>xus</>}
              description="A gamified social hub, adding a new dimension of play to social inrteraction for web3 communities."
            />
          </BentoTilt>
